export default class Info {
  ...
  render(ctx, player) {
    ...
    ctx.font = '15px Verdana'
    ctx.drawImage(this.images.wood_wood, 10, 210, 50, 50)
    ctx.fillText(player.inventory.wood, 10+25, 210+45)

    ctx.fillStyle = 'white'
    ctx.font = '10px Verdana'
    ctx.fillText('Iron', 90, 205)
    ctx.drawImage(this.images.ore_iron, 75, 210, 50, 50)
    ctx.font = '15px Verdana'
    ...
    ctx.drawImage(this.images.ore_bronze, 140, 210, 50, 50)
    ctx.font = '15px Verdana'
    ...
    ctx.drawImage(this.images.ore_silver, 10, 290, 50, 50)
    ctx.font = '15px Verdana'
    ...
    ctx.drawImage(this.images.ore_gold, 75, 290, 50, 50)
    ctx.font = '15px Verdana'
    ...
    ctx.drawImage(this.images.ore_platinum, 140, 290, 50, 50)
    ctx.font = '15px Verdana'
    ...
    ctx.drawImage(this.images.ore_amethyst, 10, 370, 50, 50)
    ctx.font = '15px Verdana'
    ...
    ctx.drawImage(this.images.ore_sapphire, 75, 370, 50, 50)
    ctx.fillStyle = 'white'
    ctx.font = '15px Verdana'
    ...
    ctx.drawImage(this.images.ore_emerald, 140, 370, 50, 50)
    ctx.font = '15px Verdana'
    ...
    ctx.drawImage(this.images.ore_ruby, 10, 450, 50, 50)
    ctx.font = '15px Verdana'
    ...
    ctx.drawImage(this.images.ore_diamond, 75, 450, 50, 50)
    ctx.font = '15px Verdana'
    ...
    ctx.drawImage(this.images.ore_alexandrite, 140, 450, 50, 50)
    ctx.font = '15px Verdana'
